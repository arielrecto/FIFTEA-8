...
<section class="bg-gray-100">
    <div class="max-w-[1300px] mx-auto px-4">
        ...
        @if (count($products) === 0)
            <div class="py-20">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-10 md:space-y-0">
                    <div class="w-full md:w-1/2 flex items-center justify-center relative" data-aos="fade-right"
                        ...
                        <div
                            class="w-[160px] h-[250px] md:w-[260px] md:h-[360px] border border-sbgreen rotate-12 absolute">
                        </div>
                        ...
                        <div class="hover:transform hover:scale-105 transition duration-300 ease-in-out">
                            <img src="{{ asset('images/choco/White Caramel.png') }}" alt=""
                                class="shadow-md w-[150px] h-[200px] md:w-[280px] md:h-[380px] bg-gradient-to-tr from-sbdlight to-white -rotate-12">
                        </div>
                    </div>
                    <div class="w-full md:w-1/2 flex items-center justify-center pt-10 md:pt-0">
                        <div class="flex flex-col space-y-6 items-center justify-center">
                            ...
                            <p class="flex flex-col text-lg text-gray-600 text-center md:text-left" data-aos="fade-left"
                                ...
                                <span>caramel in our White Caramel Milk Tea for a sip of pure </span>
                                <span>delight and indulgence.</span>
                            </p>
            ...
            <div class="py-20">
                <div class="flex flex-col md:flex-row-reverse items-center justify-between space-y-10 md:space-y-0">
                    <div class="w-full md:w-1/2 flex items-center justify-center relative" data-aos="fade-left"
                        data-aos-duration="2000" data-aos-delay="100">
                        <div
                            class="w-[160px] h-[250px] md:w-[260px] md:h-[360px] border border-sbgreen rotate-12 absolute">
                        </div>
                        <div class="hover:transform hover:scale-105 transition duration-300 ease-in-out">
                            <img src="{{ asset('images/choco/Strawberry.png') }}" alt=""
                                class="shadow-md w-[150px] h-[200px] md:w-[280px] md:h-[380px] bg-gradient-to-tr from-sbdlight to-white -rotate-12">
                        </div>
                        <div class="hover:transform hover:scale-105 transition duration-300 ease-in-out z-[5]">
                            <img src="{{ asset('images/sberry.png') }}" alt=""
                                class="w-[120px] h-[150px] md:w-[200px] md:h-[220px] rotate-12">
                        </div>
                    </div>
                    <div class="w-full md:w-1/2 flex items-center justify-center pt-10 md:pt-0">
                        <div class="flex flex-col space-y-6 items-center justify-center">
                            <h1 class="abril text-4xl md:text-6xl font-bold text-gray-900 text-center md:text-left"
                                data-aos="fade-right" data-aos-duration="2000" data-aos-delay="100">Strawberry</h1>
                            <p class="flex flex-col text-lg text-gray-600 text-center md:text-left"
                                data-aos="fade-right" data-aos-duration="2000" data-aos-delay="200">
                                <span>Savor the exquisite blend of creamy white milk and sophisticated </span>
                                <span>caramel in our White Caramel Milk Tea for a sip of pure </span>
                                <span>delight and indulgence.</span>
                            </p>
            ...
            <div class="py-20">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-10 md:space-y-0">
                    ...
                    <div class="w-full md:w-1/2 flex items-center justify-center pt-10 md:pt-0">
                        <div class="flex flex-col space-y-6 items-center justify-center">
                            <h1 class="abril text-4xl md:text-6xl font-bold text-gray-900 text-center md:text-left"
                                data-aos="fade-left" data-aos-duration="2000" data-aos-delay="100">{{$product->name}}</h1>
                            {{-- <p class="flex flex-col text-lg text-gray-600 text-center md:text-left" data-aos="fade-left"
                                data-aos-duration="2000" data-aos-delay="120">
                                <span>Savor the exquisite blend of creamy white milk and sophisticated </span>
                                <span>caramel in our White Caramel Milk Tea for a sip of pure </span>
