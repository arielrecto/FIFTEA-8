    ...
    <div class="container mx-auto flex  md:flex-row flex-col items-center px-5 md:px-22 lg:px-28 py-24 pt-12 pb-52 pb-5">
        ...
        <div
            ...
            <h1 data-aos="fade-left" data-aos-duration="2000" data-aos-delay="400"
                class="title-font font-sans sm:text-4xl text-5xl mb-4 font-medium text-gray-900">Unlock the
                extraordinary with our exclusive milk tea creations.

            </h1>
            <p data-aos="fade-left" data-aos-duration="2000" data-aos-delay="400"
                class="font-sans mb-8 leading-relaxed">At Fif'tea-8, we're passionate about crafting the finest milk
                teas that will transport your taste buds to new heights of satisfaction. From classic favorites to
        ...
        <div class="flex items-center justify-center -m-4">
            <div class=" flex space-x-2">
                ...
                <div class="p-4 lg:w-1/3 hover:transform hover:scale-105 transition duration-500 ease-in-out">
                    <div
                        class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden shadow bg-white">
                        <img class="lg:h-80 md:h-60 w-full object-cover object-center"
                            src="{{ asset('images/choco/Kiwi.png') }}" alt="blog">
                ...
                <div class="p-4 lg:w-1/3 hover:transform hover:scale-105 transition duration-500 ease-in-out">
                    <div
                        class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden shadow bg-white">
                        <img class="lg:h-80 md:h-60 w-full object-cover object-center"
                            src="{{ asset('images/choco/Hokkaido.png') }}" alt="blog">
                        <div class="p-6 bg-gray-100">
                            <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY</h2>
                ...
                <div class="p-4 lg:w-1/3 hover:transform hover:scale-105 transition duration-500 ease-in-out ">
                    <div
                        class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden shadow bg-white">
                        <img class="lg:h-80 md:h-60 w-full object-cover object-center"
                            src="{{ asset('images/choco/BlueBerry.png') }}" alt="blog">
                        <div class="p-6 bg-gray-100">
                            <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY</h2>
