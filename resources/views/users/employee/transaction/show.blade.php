    ...
    <section class="p-5 flx flex-col space-y-5">
        <div class="flex items-start space-x-4">
            <div class="flex flex-col gap-2 h-full w-full">
                <div class="grid grid-cols-2 grid-flow-row border-2 bg-gray-200 h-fit p-2 rounded ">
                    <div class="w-full flex flex-col gap-2">
                        <h1 class="text-lg font-semibold">Transaction Number</h1>
                        <h1 class="text-sm">
                            {{ $transaction->transaction_ref }}
                        </h1>
                    </div>
                    <div class="w-full flex flex-col gap-2">
                        <h1 class="text-lg font-semibold">Order Number</h1>
                        <h1 class="text-sm">
