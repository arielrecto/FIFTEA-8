                ...
                <div class="w-full md:w-2/6 flex flex-col space-y-4">
                    ...
                    <div class="hidden md:block rounded shadow-sm h-fit w-full bg-white pb-4">
                        <div class="w-full h-fit relative ">
                            ...
                            <img src="{{ auth()->user()->profile && auth()->user()->profile->image ? asset('storage/' . auth()->user()->profile->image) : asset('images/user-image.png') }}"
                                alt="" {{-- src="{{ $profile->image ? route('media.profile', ['name' => $profile->image]) : asset('images/user-image.png') }}" --}}
