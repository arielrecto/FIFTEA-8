            ...
            <div class="flex items-start justify-between space-x-6">
                <div class="w-full flex flex-col">
                    ...
                    <ul class="steps">
                        ...
                        <li class="step {{ $order->status === OrderStatus::PROCESSED->value
                        | $order->status === OrderStatus::DELIVERY->value | $order->status === OrderStatus::DONE->value
                        ? 'step-primary' : ' ' }}">Processed</li>
                        <li class="step {{ $order->status === OrderStatus::DELIVERY->value | $order->status === OrderStatus::DONE->value
                            ? 'step-primary' : ' ' }}">Delivery</li>
                        <li class="step {{$order->status === OrderStatus::DONE->value
                            ? 'step-primary' : ' ' }}">Done</li>
                    </ul>
