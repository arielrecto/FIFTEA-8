                                        ...
                                        <tr class="text-gray-700 dark:text-gray-400">
                                            <td class="px-4 py-3">
                                                <div class="flex items-center space-x-2">
                                                    <img class="w-12 h-12 rounded" src="{{asset($c_product->product->image)}}" alt="">
                                            ...
                                            <td class="px-4 py-3">
                                                <a href="{{route('client.cart.showProduct', ['id' => $c_product->id ])}}">
                                                    <i class='bx bx-edit text-blue-700 text-lg hover:text-sbgreen cursor-pointer'></i>
                                                </a>
                                            </td>
                                            <td class="px-4 py-3">
                                ...
                                <div class="flex flex-col space-y-2">
                                    @foreach ($cart->products as $c_product)
                                        <div class="flex justify-between items-start">
                                            <div class="flex items-center space-x-2">
                                                <img class="w-10 h-10 rounded" src="{{asset($c_product->product->image)}}" alt="">
